...
from Client.config import FinishTrainingQDialog_IconPath
from ..res_rc import *
...
class FinishTrainingDialog(QDialog, Ui_Dialog_finish_training):
    ...
    def __init__(self, parent=None):
        ...
        icon_pixmap = QPixmap(FinishTrainingQDialog_IconPath)
        scaled_pixmap = icon_pixmap.scaled(86, 86, QtCore.Qt.KeepAspectRatio, QtCore.Qt.SmoothTransformation)
        self.label_finish_icon.setPixmap(scaled_pixmap)
        self.label_finish_icon.setAlignment(QtCore.Qt.AlignCenter)
